...
export function DeviceConsole({
  ...
  useEffect(() => {
    ...
    const ws = openTelemetrySocket(session, [activeDeviceId], () => {
      if (disposed) {
        return;
      }
      setLastPushAt(Date.now());
      void Promise.all([fetchDeviceDetail(session, activeDeviceId), fetchDeviceList(session)])
        .then(([nextDevice, nextDevices]) => {
            ...
            <div className="actionRow">
              <button
                ...
                onClick={() => {
                  ...
                  void runAction("connect", () => connectDevice(session, device.id));
                }}
              >
              ...
              <button
                ...
                onClick={() => {
                  ...
                  void runAction("disconnect", () => disconnectDevice(session, device.id));
                }}
              >
                断开连接
              </button>
              <button
                ...
                onClick={() => {
                  ...
                  void runAction("refresh", () => refreshDevice(session, device.id));
                }}
              >
                刷新状态
              </button>
            ...
            <div className="actionRow">
              ...
              <button
                ...
                onClick={() => {
                  ...
                  void runAction("stop", () => stopIrrigation(session, device.id, selectedSiteNumber), {
                    siteNumber: selectedSiteNumber,
                  });
                }}
              >
          ...
          <div className="panel">
            <div className="panelHeader">
              <div>
                ...
                <p className="muted">WebSocket 实时推送，状态变化后界面立即更新。</p>
              </div>
            </div>
