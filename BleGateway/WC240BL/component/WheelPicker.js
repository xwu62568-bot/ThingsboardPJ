...
export default class WheelPicker extends React.Component {
    ...
    return (
      <View style={styles.alertView}>
        ...
        <View style={styles.contentContainer}>
          ...
          <PickerView ref={(e)=> this.picker = e} data={this.state.data} wheelOnChange1={this.wheelOnChange1.bind(this)} isCyclic={false} defaultValue={ Number(this.state.selectedValue1)} wheelWidth={180} ></PickerView>
          </View>
  ...
  //显示
  showDialog(type,data,value) {//slot 确认修改
    this.setState({
      modalVisible: true,
    ...
    setTimeout(()=>{
      this.picker && this.picker.updateValue(value)
    },1000)
  }
  _onTapOutside = () => {
    this.setState({
